...

  {
    ...
    children: [
      ...
      },
      {
        path: 'sync',
        loadComponent: () =>
          import('./features/sync/sync-dashboard.component').then((m) => m.SyncDashboardComponent),
      },
      {
        // Page de creation d'une équipe
        path: 'teams/new',
        loadComponent: () =>
          import('./features/teams/team-edit.component').then((m) => m.TeamEditComponent),
      },
      {
...

      {
        ...
        loadComponent: () =>
          import('./features/matches/match-edit.component').then((m) => m.MatchEditComponent),
      },
      {
...

      {
        ...
        loadComponent: () =>
          import('./features/events/event-edit.component').then((m) => m.EventEditComponent),
      },
